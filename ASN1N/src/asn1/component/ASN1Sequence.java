...
/**
 * The ASN1Sequence class represents an ASN.1 sequence component. It extends the more general
 * {@link ASN1Component}.
 * 
 * @author Panos Katsikogiannis
 */
public class ASN1Sequence extends ASN1Component {

	/**
	 * Creates an {@link ASN1Sequence} component.
	 * @param tag - the tag of the component.
	 * @param value - the value of the sequence component.
	 * @param name - the name of the component.
	 */
	public ASN1Sequence (short tag, ASN1Data value, String name) {
	 ...
	 * @param name - the name of the component.
	 */
	public ASN1Sequence (ASN1Data data, String name) {
		super(data, name);
		setType(SEQ_TYPE);
	}
	
	/**
	 * Creates an {@link ASN1Sequence} component with a specific tag.
	 * @param tag - the specific tag.
	 * @param value - the value of the sequence component.
	 * @param table - a table of components that could be included in the sequence component.
	 * @param name - the name of the component.
	 * @param possibleValues - the possible values that the sequence component can take.
	 * @throws ASN1Exception
	 */
	public ASN1Sequence (short tag, ASN1Data value, ASN1CustomComponent table[], String name,
	 ...
	 * @throws ASN1Exception
	 */
	public ASN1Sequence (ASN1Data data, ASN1CustomComponent table[], String name,
			ASN1ContentDecoder contentDecoder) throws ASN1Exception {
