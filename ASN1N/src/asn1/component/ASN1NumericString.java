...
public class ASN1NumericString extends ASN1Component {
	...
	/**
	 * Create a numericString component with the default tag
	 * @param value The value of the numericString component
	 */
	public ASN1NumericString (String value, String name) {
		this(ASN1_TAG_NUM_STR, value, name);
	}
